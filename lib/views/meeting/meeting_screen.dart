          ...
          body: SizedBox(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          IconButton(
                              onPressed: () async{
                                String? newRole = await showPromtDialog(context, 'Rol', initialValue: state.meetingItems[state.selectedItem].role);
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                            onPressed: () async{
                              String? newName = await showPromtDialog(context, 'Nombre', initialValue: state.meetingItems[state.selectedItem].name);
                ...
                Expanded(child: ClockWidget(meetingItem: state.meetingItems[state.selectedItem],)),
                Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
